...
public class KeychainUtils {
    ...
    public func save(bundleIdentifier: String? = nil, key: String, data: Data) throws {
...
//            kSecAttrAccessGroup: accessGroup, // Keychain에 저장되기 때문에 유니크한 identifier으로 앱간의 공유 데이터로 사용
    ...
    public func delete(bundleIdentifier: String? = nil, key: String) throws {
...
//               kSecAttrAccessGroup: accessGroup
    ...
    public func read(bundleIdentifier: String? = nil, key: String) throws -> Data? {
...
//            kSecAttrAccessGroup: accessGroup,
    ...
    public func update(bundleIdentifier: String? = nil, key: String, data: Data) throws {
